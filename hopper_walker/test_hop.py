...
xml_file_global = "/home/master-andreas/gym-mjc-v5-model-validation/hopper.xml"
xml_file_local = "/home/master-andreas/gym-mjc-v5-model-validation/hopper_saran_t_trans2.xml"
global_env = hopper.HopperEnv(exclude_current_positions_from_observation=False, xml_file=xml_file_global, render_mode=None)
local_env = hopper.HopperEnv(exclude_current_positions_from_observation=False, xml_file=xml_file_local, render_mode=None)
